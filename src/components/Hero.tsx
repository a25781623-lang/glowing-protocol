      ...
      <div className="relative z-20 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            ...
            cutting-edge blockchain protocol. Join thousands of developers building
          ...
          <div className="grid grid-cols-3 gap-8 pt-12 max-w-2xl mx-auto">
            ...
            <div className="space-y-2">
              <div className="text-3xl font-bold text-primary animate-fade-in" style={{ animationDelay: '0.1s' }}>
                &lt;2s
              </div>
              <div className="text-sm text-muted-foreground">
                Finality Time
            ...
            <div className="space-y-2">
              <div className="text-3xl font-bold text-primary animate-fade-in" style={{ animationDelay: '0.2s' }}>
                $0.001
              </div>
              <div className="text-sm text-muted-foreground">
                Avg. Fee
